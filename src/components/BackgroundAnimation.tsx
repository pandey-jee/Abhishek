...
export const BackgroundAnimation = () => {
  return (
    <div className="fixed inset-0 pointer-events-none overflow-hidden z-0">
      ...
      <motion.div
        className="absolute top-1/2 -right-40 w-[600px] h-[600px] bg-secondary/20 rounded-full blur-[150px]"
        animate={{
          x: [0, -100, 0],
          y: [0, 100, 0],
          scale: [1, 1.3, 1],
      ...
      <motion.div
        className="absolute bottom-1/4 left-1/3 w-[400px] h-[400px] bg-accent/15 rounded-full blur-[120px]"
        animate={{
          x: [0, -80, 0],
          y: [0, 80, 0],
          scale: [1, 1.1, 1],
